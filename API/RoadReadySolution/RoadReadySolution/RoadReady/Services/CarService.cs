...
namespace RoadReady.Services
{
    public class CarService : ICarAdminService,ICarUserService
    {
        ...
        public async Task<Car> AddDiscountToCar(int carId, int discountId)
        {
                ...
                //    if (car != null)
                //    {
                //        // Check if the discount is already applied to the car
                //        if (car.Discounts.Any(d => d.DiscountId == discount.DiscountId))
                //        {
                //            _logger.LogWarning($"Discount with ID {discount.DiscountId} is already applied to the car with ID {carId}");
                //            throw new DiscountAlreadyExistsException();
                //        }

                //        // Apply the discount to the car
                ...
                //catch (Exception ex)
                //{
                //    _logger.LogError($"Error in AddDiscountToCar: {ex.Message}");
                //    throw;
                //}
            }
        #endregion
